...
const Footer = () => {
  return (
    <footer
      id="contact"
      className="bg-slate-900 text-slate-300 py-16 px-6 md:px-10 lg:px-20"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mb-6 text-sm">
              Next-generation hotel management system that streamlines
              operations and enhances guest experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin
                  size={20}
                  className="mt-0.5 min-w-[20px] text-primary"
                />
                <span>
                  806/5 Signet Hub
                  <br />
              ...
              <li className="flex items-center gap-3">
                ...
                <span>+91 9825720827</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={20} className="min-w-[20px] text-primary" />
                <span>management@innvoket.com</span>
              </li>
            </ul>
          </div>
